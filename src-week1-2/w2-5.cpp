...
void Test2w5(std::vector<std::string> source, std::vector<std::string> destination, const std::vector<std::string>& expected)
{
    cout << "Testing: ";
    PrintVector(source);
    cout << " vs ";
...
void RunTests2w5()
{
    Test2w5({"a", "b" , "c"}, {"z"}, {"z", "a", "b" , "c"});
    Test2w5({"a"}, {"b"}, {"b", "a"});
    Test2w5({"d", "e" , "f"}, {"a", "b" , "c"}, {"a", "b" , "c", "d", "e" , "f"});
}
