...
void Test1w5(double price, double discount_small_limit, double discount_big_limit, float discount_small_percent, float discount_big_percent, double expected)
{
...
void RunTests1w5()
{
    Test1w5(100, 110, 120, 5, 10, 100);
    Test1w5(115, 110, 120, 5, 10, 109.25);
    Test1w5(150, 110, 120, 5, 12.5, 131.25);
}
